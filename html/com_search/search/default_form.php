...
<form class="uk-form uk-margin-bottom " id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
	...
	<div class="uk-panel uk-panel-box uk-padding">
		...
		<fieldset>
			<div class="uk-form-row">
				...
				<input class="uk-input uk-form-width-medium" type="text" name="searchword" placeholder="<?php echo JText::_('COM_SEARCH_SEARCH_KEYWORD'); ?>" id="search-searchword" size="30" maxlength="<?php echo $upper_limit; ?>" value="<?php echo $this->escape($this->origkeyword); ?>" class="inputbox" />
				<button name="Search" onclick="this.form.submit()" class="uk-button uk-button-default uk-text-uppercase" title="<?php echo JHtml::tooltipText('COM_SEARCH_SEARCH');?>"><?php echo JHtml::tooltipText('COM_SEARCH_SEARCH');?></button>
	...
	<div class="searchPagination uk-margin-top<?php echo $this->params->get('pageclass_sfx'); ?>">
